...
class Producto:
    ...
    def actualizar(self, cantidad: Optional[int] = None, precio: Optional[float] = None):
...
class Inventario:
    def __init__(self, archivo_datos: str = "Base de datos inventario.json"):
    ...
    def eliminar_producto(self, id_producto: str):
        if self.productos.pop(id_producto, None):
            self.guardar_en_archivo()
